...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/mealtimes/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ? await requestPUT_NEW(`api/v1/mealtimes/${id}`, formData)
        : await requestPOST_NEW(`api/v1/mealtimes`, formData);
          ...
          {!loadding && (
            ...
            >
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-6">
                  <FormItem label="Đóng đăng ký trước ca(h)" name="limitedHour">
