...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/maritalstatuses/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ? await requestPUT_NEW(`api/v1/maritalstatuses/${id}`, formData)
        : await requestPOST_NEW(`api/v1/maritalstatuses`, formData);
