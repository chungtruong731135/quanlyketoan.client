  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = await requestPOST(
        `api/v1/reports/doanh-thu-khoa-hoc-time`,
        body
      );
      var _data = res?.data ?? [];
      setDataTable(_data);
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const res = await requestDOWNLOADFILE(
        `api/v1/reports/export-doanh-thu-khoa-hoc-time`,
        body
      );
      // Xử lý dữ liệu
          ...
          <div className="p-5">
            ...
            <div class="d-flex flex-column flex-shrink-0 ms-4 mt-2 text-dark fs-6">
              ...
              <span class="d-flex align-items-center mb-2">
                <i className="fas fa-minus me-3"></i>
                <span className="fw-bolder">
                  {dataTK?.distributorCount?.toLocaleString()}
                </span>
                <span className="mx-2">
                  lượt kích hoạt qua đại lý, trị giá:
                </span>
                <span className="fw-bolder">
              ...
              <span class="d-flex align-items-center mb-2">
                <i className="fas fa-minus me-3"></i>
                <span className="fw-bolder">
                  {dataTK?.retailerCount?.toLocaleString()}
                </span>
                <span className="mx-2">
                  lượt kích hoạt qua cộng tác viên, trị giá:
                </span>
                <span className="fw-bolder">
              ...
              <span class="d-flex align-items-center mb-2">
                <i className="fas fa-minus me-3"></i>
                <span className="fw-bolder">
                  TỔNG: {dataTK?.totalCount?.toLocaleString()}
                </span>
