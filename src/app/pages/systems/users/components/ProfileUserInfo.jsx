            ...
            >
              ...
              <tbody className='fs-6 fw-semibold text-gray-600'>
                <tr>
                  ...
                  <td>
                    <span className='fw-bold fs-6 text-dark'>{dataUserDetails?.email ?? '--'}</span>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <span className='badge badge-success'>
                      {dataUserDetails?.isActive ? 'Đang hoạt động' : 'Ngừng hoạt động'}
                    </span>
                  </td>
          ...
          <form className='form' id='kt_users_email_notification_form'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_0'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_2'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_3'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_4'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_5'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_6'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_7'>
            ...
            <div className='d-flex'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/*end::Input*/}
                {/*begin::Label*/}
                <label className='form-check-label' htmlFor='kt_modal_update_email_notification_8'>
