...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (_data) {
        _data.registrationDeadline = _data?.registrationDeadline
          ? dayjs(_data?.registrationDeadline)
          : null;
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ? await requestPUT_NEW(`api/v1/courseonlines/${id}`, body)
        : await requestPOST_NEW(`api/v1/courseonlines`, body);
